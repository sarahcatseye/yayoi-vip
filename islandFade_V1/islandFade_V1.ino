     ...
     boolean checker= 1;
      ...
      Adafruit_NeoPixel strip = Adafruit_NeoPixel(270, PIN, NEO_GRB + NEO_KHZ800);
                  int stripDim[] = {0, 76, 142, 184, 230, 268};
      ...
      int brightenCount=0;
        while(checker){
              ...
              bothdim(b1,b2,a1,a2);
              delay(50);*/
//              bothdim(stripDim[4], stripDim[5], stripDim[4], stripDim[3]);
//              delay(50);
//              bothdim(stripDim[3], stripDim[4], stripDim[3], stripDim[2]);
//              delay(50);
//              bothdim(stripDim[3], stripDim[2], stripDim[2], stripDim[1]);
//              delay(50);
//              bothdim(stripDim[2], stripDim[1], stripDim[1], stripDim[0]);
//              delay(50);
